...
public class WazaSV
{
    ...
    [FlatBufferItem(06)] public byte HitPer { get; set; }
    ...
    [FlatBufferItem(14)] public ushort AISeqNo { get; set; }
    ...
    [FlatBufferItem(18)] public WazaSVRankEff RankEff { get; set; }
    ...
    [FlatBufferItem(26)] public bool Flag_Oumu { get; set; }
...
public struct WazaSVSick
{
    ...
    [FieldOffset(2)] public byte Per;
    [FieldOffset(3)] public byte Cont;
    ...
    {
        return $"{Id},{Per},{Cont},{TurnMin},{TurnMax}";
    }
}

[FlatBufferStruct]
[StructLayout(LayoutKind.Explicit)]
public struct WazaSVRankEff
{
    [FieldOffset(0)] public byte Type1;
    [FieldOffset(1)] public sbyte Value1;
    [FieldOffset(2)] public byte Per1;

    [FieldOffset(3)] public byte Type2;
    [FieldOffset(4)] public sbyte Value2;
    [FieldOffset(5)] public byte Per2;

    [FieldOffset(6)] public byte Type3;
    [FieldOffset(7)] public sbyte Value3;
    [FieldOffset(8)] public byte Per3;

    public override string ToString()
    {
        return $"{Type1}/{Value1}/{Per1}, {Type2}/{Value2}/{Per2}, {Type3}/{Value3}/{Per3}";
    }
}
