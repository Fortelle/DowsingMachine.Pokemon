...
public class TegraX1Swizzle
{
    ...
    // 64 Bit.
    [DllImport("Lib/tegra_swizzle_x64", EntryPoint = "deswizzle_block_linear")]
    ...
    [DllImport("Lib/tegra_swizzle_x64", EntryPoint = "swizzle_block_linear")]
